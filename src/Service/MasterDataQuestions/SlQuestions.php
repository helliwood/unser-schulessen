...
class SlQuestions
{
    public const TEMPLATE_ROOT = 'master_data/forms/sl' ;
    ...
    public static $config = [
        [
            ...
            'items' => [
                ...
                "students_current" => [
                    'type' => IntegerType::class,
                    'label' => "Essensteilnehmer aktuell",
                    'help' => 'Angabe in Ziffern',
                    'required' => true,
                    'range' => ['min' => 0, 'max' => 1999],
                ...
                "class_level_1_4" => [
                    'type' => IntegerType::class,
                    'label' => "Essensteilnehmer Klassen 1–4",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                "class_level_5_10" => [
                    'type' => IntegerType::class,
                    'label' => "Essensteilnehmer Klassen 5–10",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                "class_level_11_13" => [
                    'type' => IntegerType::class,
                    'label' => "Essensteilnehmer Klassen 11–13",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                ...
                "opening_hours_kiosk_to" => [
                    'type' => TimeType::class,
                    'placeholder' => '--',
                    'label' => "Öffnungszeiten des Kiosk/Imbiss bis",
                    'required' => false,
                    'transformer' => 'datetime',
                    'validation' => [['GreaterThanOrEqual' => 'opening_hours_kiosk_from']]
        ...
        [
            ...
            'items' => [
                ...
                "dge_certified" => [
                    'type' => ChoiceType::class,
                    'label' => "Der Verpflegungsanbieter hat eine DGE-zertifizierte Menülinie",
                    'required' => true,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
                ...
                "dge_checks" => [
                    'type' => ChoiceType::class,
                    'label' => "Der Verpflegungsanbieter ist verpflichtet Eigenkontrollen zur Umsetzung des DGE-Qualitätsstandards durchzuführen und zu dokumentieren",
                    'required' => false,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
                ...
                "food_supplier_in_ag" => [
                    'type' => ChoiceType::class,
                    'label' => "Der Verpflegungsanbieter beteiligt sich aktiv an AG zur Verpflegungsqualität",
                    'required' => false,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
...
//                    'help' => "Caféteria-Linie: Die Tischgäste bestücken ihr Tablett entlang einer Theke z.T. selbst (z.B. mit den vorportionierten kalten Speisen (eventuell auch mit Getränken)), warme Hauptgerichte werden vom Personal ausgegeben. Free-Flow: die Tischgäste können sich frei an verschiedenen Ausgabestationen ihre Mittagsmahlzeit zusammenstellen"
                ...
                "warm_keeping_period" => [
                    'type' => TimeType::class,
                    'placeholder' => '--',
                    'label' => "Die maximale Heißhaltezeit für das Mittagessen beträgt (in Stunden)",
                    'required' => true,
                    'transformer' => 'datetime',
                    'help' => "Hier bitte nur die Standzeiten in der Schule bis zum Ende der Speisenausgabe angeben. Zur Heißhaltezeit insgesamt gehören die Standzeiten im Herstellungsbetrieb, die Transportzeiten von der Küche zur Schule und die Standzeiten in der Schule. Diese dürfen 3 h nicht überschreiten."
                ],
                "communication" => [
                    'type' => TextareaType::class,
        ...
        [
            ...
            'items' => [
                ...
                "catering_officer" => [
                    'type' => ChoiceType::class,
                    'label' => "Ein Verpflegungsbeauftragter von Seiten der Schule ist benannt",
                    'required' => true,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
                ...
                "catering_officer_contact" => [
                    'type' => TextareaType::class,
                    'label' => "(Mail-)Kontakt Verpflegungsbeauftragte*r/Ansprechperson in der Schule",
                    'required' => false,
                ],
                "student_survey" => [
                    'type' => ChoiceType::class,
                    'label' => "Der Verpflegungsanbieter ist verpflichtet mindestens einmal jährlich eine Schülerbefragung zur Zufriedenheit mit dem Schulessen durchzuführen.",
                    'required' => false,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
        ...
        [
            ...
            'items' => [
                ...
                "price" => [
                    ...
                    'label' => "Der aktuelle Abgabepreis beträgt",
                    'required' => true,
                    'help' => "EE,CC",
                    'validation' => [['GreaterThanOrEqual' => 'price_from'], ['LessThanOrEqual' => 'price_to']]
                ],
                "price_from" => [
                    'type' => MoneyType::class,
                ...
                "school_subsidies" => [
                    ...
                    'help' => "Ist im Vertrag mit dem Verpflegungsanbieter ein direkter Zuschuss des Schulträgers zum Mittagessen vereinbart?",
                ],
