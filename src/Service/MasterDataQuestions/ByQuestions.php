...
class ByQuestions
{
    public const TEMPLATE_ROOT = 'master_data/forms/by';
    ...
    public static $config = [
        ...
        [
            ...
            'items' => [
                ...
                "bio" => [
                    'type' => ChoiceType::class,
                    'label' => "Der Anteil an Bio-Lebensmitteln ist vertraglich festgelegt",
                    'required' => true,
                    'choices' => [
                        'Ja' => 'yes',
                        'Nein' => 'no',
                ...
                "bio_ratio" => [
                    'type' => IntegerType::class,
                    'label' => "Vertraglich festgelegter Anteil an Bio-Lebensmitteln (in Prozent)",
                    'required' => true,
                    'range' => ['min' => 0, 'max' => 100],
                ],
