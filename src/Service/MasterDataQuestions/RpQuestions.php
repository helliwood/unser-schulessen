...
class RpQuestions
{
    ...
    public const TEMPLATE_ROOT = 'master_data/forms/rp' ;
    ...
    public static $config = [
        [
            ...
            'items' => [
                ...
                "class_level_1_4" => [
                    'type' => IntegerType::class,
                    'label' => "Essenteilnehmer Klassen 1-4",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                "class_level_5_10" => [
                    'type' => IntegerType::class,
                    'label' => "Essenteilnehmer Klassen 5-10",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                "class_level_11_13" => [
                    'type' => IntegerType::class,
                    'label' => "Essenteilnehmer Klassen 11-13",
                    'required' => false,
                    'help' => 'Angabe in Ziffern',
                    'range' => ['min' => 0, 'max' => 1999]
                ],
                ...
                "bus_driving_times_earliest" => [
                    'type' => TimeType::class,
                    'placeholder' => '--',
                    'label' => "Busfahrzeiten der Schulbusse frühestens",
                    'required' => false,
                    'transformer' => 'datetime'
                ],
                "bus_driving_times_latest" => [
                    'type' => TimeType::class,
                    'placeholder' => '--',
                    'label' => "Busfahrzeiten der Schulbusse spätestens",
                    'required' => false,
                    'transformer' => 'datetime'
                ],
                // Ausstattung
        ...
        [
            ...
            'items' => [
                ...
                "ordering_cancellation" => [
                    'type' => TextareaType::class,
                    'label' => "Bestellungen oder Stornierungen sind möglich",
                    'required' => false,
                    'max_length' => 1000,
                ],
            ]
        ...
        [
            ...
            'items' => [
                "uniform_selling_price" => [
                    ...
                    'help' => "Zahlen alle Schüler/innen den gleichen Preis? Ein evtl. höherer Betrag bei Lehrern wird hier nicht erfasst!"
                ],
                "price" => [
